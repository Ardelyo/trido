...
Gemma 4 introduces key capability and architectural advancements:
    ...
    Extended Multimodalities – Processes Text, Image with variable aspect ratio and resolution support (all models), Video, and Audio (featured natively on the E2B E4B and E12B models).
...
Gemma 4 models are well-suited for reasoning, agentic workflows, coding, and multimodal understanding.
Documentation
Deployment and Inference

Deploying a model consists of 3 steps: creating an endpoint resource, uploading the model, and deploying the model to the endpoint.

Example deployment (Python) The code sample below creates a new endpoint, uploads the model, and deploys the model to the endpoint (Refer to vLLM documentation).

Example inference (Python)

Example inference (Cloud console) If you've deployed this model to Agent Platform, you can perform inference in the Cloud console as a JSON request:
Models Overview
...
For optimal performance with multimodal inputs, place:
    ...
    Image and/or audio content before the text in your prompt.
    Audio content after the text in your prompt.
...
All models support image inputs and can process videos as frames whereas the E2B, E4B and E12B models also support audio inputs. Audio supports a maximum length of 30 seconds. Video supports a maximum of 60 seconds assuming the images are processed at one frame per second.
Model Data
...
google/gemma-4-12B 	2026-06-03 	GA 	Serving for text generation
google/gemma-4-12B-IT 	2026-06-03 	GA 	Serving for text generation
google/gemma-4-E2B 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-E2B-it 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-E4B 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-E4B-it 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-26B-A4B 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-26B-A4B-it 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-31B 	2026-04-02 	GA 	Serving for text generation
google/gemma-4-31B-it 	2026-04-02 	GA 	Serving for text generation
Try out Gemma 4
Region
us-central1 (Iowa)
Endpoint
To test this model, you will need to deploy it to an Agent Platform endpoint.
Prompt
...
Model ID
publishers/google/models/gemma4
Version name
gemma-4-31b-it
Tags
Task
